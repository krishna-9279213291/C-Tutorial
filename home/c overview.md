...
Getting started with C programming :
 ...
 - Include Header files :
  Include necessary header files that contain declarations of functions constants, and macros that can be used in one or more source code files. Some pupular header files are as -
    stdio.h - procides input and output functions like printf and scanf.
     #include <stdio.h>

    stdlib.h - Contains functions involving memory allocation, rand function, and other utility functions.
     #include <stdlib.h>
    
    math.h - Includesn mathematical functions like sqrt, sin , cos, etc.
     #inlcude <math.h>
    
    string.h - includes functions for manipulating strings, such as strcpy, strlen, etc.
     #include <string.h>
    
    ctype.h - function for testing and mapping characters , like isalpha, isdigit, etc.
     #include <ctype.h>

    stdbool.h - defines the boolean data type and values true and false.
     #include <stdbool.h>
    
    time.h - contains fucntions for working with date and time.
     #include <time.h>
    
    limits.h - Defines various implementation - specific limits on integers types.
     #include <limits.h>
        ...
        Define any macros or constants that will be used throughout the program. Macros and constants are optional. 
            example : #include <stdio.h>
                      ...
                      int main () {
                        ...
                        printf("Area of the circke : %f\n", area);
                        return 0;
                      }

                      output : Area of the circle : 78.539749
